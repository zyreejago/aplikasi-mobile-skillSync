// ignore_for_file: unused_import, file_names, unnecessary_import, library_private_types_in_public_api, use_build_context_synchronously
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            buildFeatureCard(Icons.home, 'Mencari mentor', context, const Screen1()),
            const SizedBox(height: 20),
            buildFeatureCard(Icons.search, 'Pelatihan Keterampilan', context,
                const keterampilan1()),
            const SizedBox(height: 20),
            buildFeatureCard(
                Icons.notifications, 'Komunitas Belajar', context, Komunitas()),
          ],
        ),
      ),
